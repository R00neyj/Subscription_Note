...
export default function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-tertiary dark:bg-slate-900 md:sticky md:top-0 md:w-[90px] md:h-screen md:flex md:flex-col md:justify-between md:items-center md:py-6 md:pb-4 z-50 transition-colors duration-300">
      <div className="flex md:flex-col items-center justify-around w-full md:w-auto md:space-y-10">
        {/* btn (Add Button) */}
        <button 
          onClick={() => openModal()}
          className="hidden md:flex justify-center items-center w-[56px] h-[56px] bg-primary rounded-[12px] p-0 transition-colors hover:bg-accent-2 shadow-sm" 
            ...
            return (
              ...
              >
                ...
                <div className={cn(
                  ...
                  isActive ? "bg-primary shadow-sm" : "group-hover:bg-white/50 dark:group-hover:bg-slate-700"
                )}>
                  <img 
